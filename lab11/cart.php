...
// Aktualizowanie produktów w koszyku
...
function FinalizujZakup()
{
    ...
    // Odejmuje z bazy danych zakupione produkty
    foreach ($_SESSION['koszyk'] as $produkt) {
...
// Obliczanie ceny koncowej produktu
function ObliczSume($produkt)
{
    $suma = $produkt['ilosc'] * $produkt['cena_netto'];
    $suma += $suma * ($produkt['podatek_vat'] / 100);
    return $suma;
}

// Cena koncowa koszyka
